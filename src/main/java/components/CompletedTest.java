...
public class CompletedTest extends Test {
    ...
    public CompletedTest(String title, Category category, String firstInput, String secondInput, String thirdInput, int[] expected, boolean exceptionExpected, String exceptionText) {
